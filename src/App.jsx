          ...
          <div className="w-[100%] lg:w-[93%] mx-auto mb-10 overflow-hidden">
            ...
            <div className="hidden lg:grid grid-cols-2 lg:grid-cols-6 gap-3 mt-3 p-1 md:p-4">
              ...
              <div className="hidden md:block row-span-2 col-span-2 relative lg:col-span-2 rounded-tr-[40px] rounded-bl-[40px]">
                ...
                <img
                  src="/anim.png"
                  className="w-30 h-30 absolute right-10 -top-16 z-30 animate-spin-slow"
                  alt="anim"
                />
                ...
                {!play ? (
                  // Poster + Play tugmasi
                  <div
                    className="relative w-full h-105 cursor-pointer"
                ...
                {images.map((item, index) => (
                  ...
                  >
                    <img
                      ...
                      className=" w-[60%] md:w-[40%] h-35 md:h-40 object-contain mb-4 mx-auto"
                    />
